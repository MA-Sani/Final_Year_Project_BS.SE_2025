...
const Home = () => {
    return ( <
        ...
        alt = "Background"
        layout = "fill"
        objectFit = "cover" / > { /* Heading , subheading , Learn More Button */ } <
        ...
        <
        Link href = { "/tools" }
        className = 'px-5 py-3 bg-yellow-500 text-gray-900 hover:bg-yellow-400 font-semibold rounded-md' > Lean More < /Link> <
        /div> <
        /div> <
        />
    )
